...
public partial class NoverDbContext : DbContext
{
    public NoverDbContext()
    {
    }

    public NoverDbContext(DbContextOptions<NoverDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Complaint>(entity =>
        {
            ...
            entity.HasOne(d => d.Track).WithMany(p => p.Complaints)
                .HasForeignKey(d => d.TrackId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_complaints_tracks");
            ...
            entity.HasMany(d => d.Singers).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Singer>().WithMany()
                        .HasForeignKey("SingerId")
                        .HasConstraintName("user_subscriptions_artist_id_fkey"),
